...
def login():
    ...
    resize_image = image.resize((315, 275))
    ...
    # Add Text
    canvas3.create_text(150,25, text = "Please enter details below to log into ur acc",font=("david",12),fill='white')
...
def main_account_screen():
    ...
    # Add Text
    canvas1.create_text(800,110, text = "Welcome to shopezee",font=("david", 45, 'bold'),fill='purple')
    canvas1.create_text(800,435, text = "New here? Register now!",font=("david", 20))

    #add buttons
    button1=Button(main_screen,text="Login", height="3", width="25",command = login,font=("david", 25, 'bold'),fg="lawn green",bg='blue',bd=5)
    button2=Button(main_screen,text="Register", height="3", width="25",command=f,font=("david", 25, 'bold'),fg="lawn green",bg='blue',bd=5)
    ...
    # Display Buttons
    button1_canvas = canvas1.create_window( 550, 250, anchor = "nw",window = button1)
    button2_canvas = canvas1.create_window( 550,470,anchor = "nw",window = button2)
    button3_canvas = canvas1.create_window( 1400, 755,anchor = "nw",window = button3)
